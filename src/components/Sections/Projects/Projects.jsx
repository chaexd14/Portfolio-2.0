...
function Projects() {
  ...
  return (
    <>
      {/* Projects */}
      <section className="flex flex-col items-center justify-center w-full gap-10 p-12 h-fit desktop:w-[90%]">
        ...
        <motion.div
          ...
          <div className="grid grid-cols-1 gap-8 w-fit desktop:grid-cols-4 desktop:gap-16">
            {Projects_List.map((project) => (
              <motion.div
                ...
                <motion.div className="z-10 h-[70%] flex flex-col justify-evenly p-5 transition-all duration-300 ease-in-out group-hover:h-[80%] desktop:h-[60%] desktop:group-hover:h-[70%]">
                  <div className="mb-2 h-fit desktop:mb-4">
                    <h1 className="mb-2 text-xl font-semibold text-white desktop:text-xl">
                      {project.title}
                    </h1>
                    <p className="text-[#D9D9D9] text-sm desktop:text-lg">
                      {project.description}
                    </p>
                  </div>
