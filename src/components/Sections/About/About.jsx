...
function About() {
  ...
  return (
    <>
      {/* About */}
      <section
        className="h-fit w-[100%] flex flex-col gap-10 p-12 desktop:w-[85%]"
        id="about">
        ...
        <div className="flex flex-col items-center gap-10 desktop:flex-row desktop:gap-20">
          <div className="h-full min-w-[250px] desktop:min-w-[350px]">
          ...
          <div className="h-full w-full flex flex-col gap-8 text-sm text-center leading-relaxed text-[#D9D9D9] desktop:text-xl desktop:text-justify">
            <BlurText
              text="I'm a 4th-year IT student at Rizal Technological University who enjoys coding and problem-solving as I work toward becoming a Full Stack Web Developer. I am focused on developing my technical skills and gaining practical experience to prepare for a professional career in Web Development."
              delay={50}
              animateBy="words"
              direction="top"
